...
namespace Rosto
{
    internal class User : IUser
    {
                    ...
                    Manageragain:
                        ...
                        switch (ManagerChoice)
                        {
                            ...
                            case MangerChoices.DeleteEmp:
                                ...
                                Methods.TopColorfullCorners(0);
                                Manager.DeleteEmp();
                                Methods.displayMiddleScreen("Employee has been DELETED\n");
                                Methods.BotColorfullCorners(0);
                                goto Manageragain;
        ...
        {
            List<string> BranchesList = new List<string> { $"Greetings  {Methods.Welcome()}","~~~~~~~~~~~~~~~~~~~~~","❶ Pizza Branch ❶", "❷ Sandwitches Branch ❷", "❸ Ramen Branch ❸", "❹ Exit ❹" };
